defmodule TodoIst.Repo.Migrations.CreateTodosTable do
  ...
  def change do
    # Create enum types
    execute "CREATE TYPE priority AS ENUM ('very-low', 'low', 'medium', 'high', 'very-high', 'urgent')",
            "DROP TYPE IF EXISTS priority"

    execute "CREATE TYPE todo_status AS ENUM ('todo', 'in-progress', 'review', 'completed')",
    ...
    create table(:todos, primary_key: false) do
      ...
      add :created_by, references(:users, type: :binary_id, on_delete: :delete_all)
